...
checkout_target = os.path.join(current_dir,'cache','svn_mpmath%(revision)s')
checkout_cmd = 'co http://mpmath.googlecode.com/svn/trunk@%(revision)s '
